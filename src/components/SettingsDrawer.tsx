...
import { useSettings, type ColorTheme, type FontSize, type CardDensity, type DocType, type HumanizerIntensity, type CanvasWidth, type LineSpacing, type AutosaveInterval, type ExportFormat, type ChatDefault } from '@/contexts/SettingsContext';
import { useAuth } from '@/contexts/AuthContext';
import { Palette, Type, LayoutGrid, FileText, Wand2, Maximize, Space, Timer, Download, MessageCircle, Zap, Eye, User, LogOut, RotateCcw } from 'lucide-react';
