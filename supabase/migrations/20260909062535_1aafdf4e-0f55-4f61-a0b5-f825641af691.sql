...
grant select, insert, update, delete on public.coach_pattern_log to authenticated;
grant all on public.coach_pattern_log to service_role;
...
grant select, insert, delete on public.coach_tips_history to authenticated;
grant all on public.coach_tips_history to service_role;
